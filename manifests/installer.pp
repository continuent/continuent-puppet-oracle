class oracle::installer {
  ...
  exec {'unzip_installer':
    command => "unzip -o ${oracle::installFiles}/linux.x64_11gR2_database_1of2.zip -d /app/oracle/install; unzip -o ${oracle::installFiles}/linux.x64_11gR2_database_2of2.zip -d /app/oracle/install",
